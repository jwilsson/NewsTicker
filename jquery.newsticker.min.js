 ...
 */
(function(a){a.fn.NewsTicker=function(b){var e={id:"",height:0,timeout:null},d={interval:5000,speed:800,pauseOnHover:true};if(b){a.extend(d,b)}function c(){console.log(e.id);console.log(e.height);e.timeout=setTimeout(function(){a(e.id+" li:first").animate({marginTop:e.height},d.speed,function(){a(this).detach().appendTo(e.id).removeAttr("style")});c()},d.interval)}return this.each(function(){var f=a(this);f.css("overflow","hidden");e.id="#"+f.attr("id");e.height=f.height();c();if(d.pauseOnHover){f.bind("mouseover",function(){clearTimeout(e.timeout)}).bind("mouseout",function(){c()})}})}}(jQuery));